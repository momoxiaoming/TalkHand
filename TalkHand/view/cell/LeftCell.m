...
-(void)configMessage:(BaseMsg*) msg{
    ...
    //设置头像
    NSString *imgurl=[[FMDConfig sharedInstance]getUserInfoWithId:[msg valueForKey:@"otherid"]][@"iconUrl"];
    ...
    if(type==[textMsg integerValue]){//文字
        ...
        msg_text.textColor=[UIColor redColor];
...
//         msg_text.textColor=[UIColor redColor];
        ...
        _ImageView=[[UIImageView alloc]init];
        _ImageView.image=[UIImage imageNamed:@"message_voice_receiver_playing_3"];
        ...
        [_ImageView mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.left.equalTo(self.content_View);
        ...
        [imgarr addObject:[UIImage imageNamed:@"message_voice_receiver_playing_1"]];
        [imgarr addObject:[UIImage imageNamed:@"message_voice_receiver_playing_2"]];
        [imgarr addObject:[UIImage imageNamed:@"message_voice_receiver_playing_3"]];
     ...
     [self setListener:_Tx_img index:4];
...
-(void)menuAction:(id)sender{
    ...
    if(index==1){
        ...
        [_cellDelete cellClick:5 isright:1 object:self.itemMsg];
        
        
        
        
        
    }else if(index==3){ //点击视频
        [_cellDelete cellClick:2 isright:1 object:self.itemMsg];
    }else if(index==4){ //点击头像
          [_cellDelete cellClick:4 isright:1 object:self.itemMsg];
    }
...
-(void)createView{
    ...
    //设置图片
    UIImage *bg=[UIImage imageNamed:@"icon_qpw"];
    ...
    [self.content_View mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.Tx_img).offset(10);
        make.left.equalTo(_Tx_img.mas_right).offset(25);
    ...
    [self.msg_bg_img mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(self.content_View).offset(-15);
    ...
    [self.time_label mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(_msg_bg_img.mas_right).offset(5);
        make.centerY.equalTo(_Tx_img);
